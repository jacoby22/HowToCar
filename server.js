...
app.get('/user', function (req, res) {
  ...
  client.connect(function(err) {
    if (err) throw err;
    client.query('INSERT INTO garage (email) values ($1) WHERE NOT EXISTS (SELECT email FROM example_table WHERE email = $1)', [req.user._json.email], function(err, result) {
      if (err) throw err;
